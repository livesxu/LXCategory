...
+ (instancetype)fcx_arrayWithObjects:(id  _Nonnull const [])objects count:(NSUInteger)cnt {
    ...
    return [self fcx_arrayWithObjects:validObjects count:count];
}
...
- (id)fcx_safeObjectAtIndexedSubscript:(NSUInteger)index {
    
    if (self.count > index) {
        return [self fcx_safeObjectAtIndexedSubscript:index];
    }else {
...
+ (void)load {
    ...
    dispatch_once(&onceToken, ^{
        ...
        //        NSArray
        [self swizzleClassMethodWithClass:[NSArray class] originalSelector:@selector(arrayWithObjects:count:) swizzledMethod:@selector(fcx_arrayWithObjects:count:)];
        ...
        [self swizzleInstanceMethodWithClass:NSClassFromString(@"__NSArrayI") originalSelector:@selector(objectAtIndexedSubscript:) swizzledMethod:@selector(fcx_safeObjectAtIndexedSubscript:)];
        ...
        [self swizzleInstanceMethodWithClass:NSClassFromString(@"__NSArrayM") originalSelector:@selector(objectAtIndexedSubscript:) swizzledMethod:@selector(fcx_safeObjectAtIndexedSubscript:)];
